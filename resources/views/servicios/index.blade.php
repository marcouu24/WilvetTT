...
@section("contenido")
    ...
    <div class="row">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
            <a href="{{route('servicios.crear')}}" class="btn btn-danger float-left text-white"><i class="fas fa-plus text- float-left right"></i> Agregar Servicio</a>
          </div>
...
<script>
    $(function () {   
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ route('servicios.listar') }}",
            columns: [
            {data: 'id', name: 'id'},
            {data: 'nombre', name: 'nombre'},      
            {data: 'descripcion', name: 'descripcion'},    
            {data: 'valor_servicio', name: 'valor_servicio'}, 
