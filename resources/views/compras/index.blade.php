...
@section("contenido")
    ...
    <div class="row">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
            <a href="{{route('compras.crear')}}" class="btn btn-danger float-left text-white"><i class="fas fa-plus text- float-left right"></i>Registrar Compra</a>
          </div>
...
<script>
    $(function () {   
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ route('compras.listar') }}",
            columns: [
            {data: 'id', name: 'id',className: 'dt-right'},
            {data: 'proveedor', name: 'proveedor',className: 'dt-right'},      
            {data: 'fecha_compra', name: 'fecha_compra' ,className: 'dt-right'},    
            {data: 'total_compra', name: 'total_compra',className: 'dt-right'},    
