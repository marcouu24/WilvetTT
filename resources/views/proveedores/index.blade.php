...
@section("contenido")
    ...
    <div class="row">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
            <a href="{{route('proveedores.crear')}}" class="btn btn-danger float-left text-white"><i class="fas fa-plus text- float-left right"></i> Agregar Proveedor</a>
          </div>
